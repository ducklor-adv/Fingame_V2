// Script to add 4 new users with ACF placement
const fs = require('fs');
...
async function addFourUsers() {
  const client = await pool.connect();

  try {
    console.log('📝 Reading SQL file...');
    const sql = fs.readFileSync('./insert_four_users_with_acf.sql', 'utf8');
    ...
    console.log('✅ Four new users added successfully with ACF placement!');
    ...
    console.log('\n✅ Complete! 4 new users added to system_root network with ACF placement.');
    console.log('\n📊 Total users invited by system_root: 9 users');
    console.log('   (25AAA0001, 25AAA0002, 25AAA0004-25AAA0011)');
