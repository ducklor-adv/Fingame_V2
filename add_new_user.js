// Script to add new user invited by Somchai
const fs = require('fs');
...
async function addNewUser() {
  ...
  try {
    ...
    const sql = fs.readFileSync('./insert_new_user.sql', 'utf8');
    ...
    console.log('\n✅ Complete! New user 25AAA0003 (Supattra) has been added.');
    console.log('\n📊 Updated Network Tree:');
    console.log('   System Root (25AAA0000)');
    console.log('   ├── Somchai Jaidee (25AAA0001)');
    console.log('   │   └── Supattra Sawadee (25AAA0003) ⭐ NEW');
