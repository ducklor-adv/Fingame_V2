// Script to add 3 new users invited by Supattra
const fs = require('fs');
...
async function addThreeUsersBySupattra() {
  const client = await pool.connect();

  try {
    console.log('📝 Reading SQL file...');
    const sql = fs.readFileSync('./insert_three_users_by_supattra.sql', 'utf8');

    console.log('🔌 Connecting to database...');
    console.log('🚀 Executing SQL script with ACF placement...');
    console.log('   Inviter: Supattra Sawadee (25AAA0003)');
    ...
    console.log('✅ Three new users added successfully with ACF placement!');
    ...
    console.log('\n✅ Complete! 3 new users added to Supattra\'s network with ACF placement.');
